...
@section('content')
    ...
    <a class='btn btn-warning mt-3 mb-3' href="{{ route('user.create') }}">Crear</a>
    <table class="table">
        <thead>
        <tr>
            <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('user.edit', $user->id) }}" class="btn btn-warning">Editar</a>
                        ...
                        <button  data-toggle="modal" data-target="#deleteModal" data-id="{{ $user->id }}" type='submit' class="btn btn-danger">Eliminar</button>
                </td>
            </tr>
        @endforeach
